var level1bossState = {
  ...
  update: function() {
    ...
    //boss will try to heal at these increments
    if (boss.health == 30) {
    ...
    //if fire button is clicked fire the weapon
    ...
    //boss bullet goes the right direction
  ...
  //melee attack on the boss, gets flung back and takes damage
  bosswhack: function() {
    if (boss.health == 0) {
      boss.kill();
